  ...
  async fetch(request) {
    ...
    const content = {
      zh: {
        ...
        version1Desc: '✅ 最簡單、最高兼容性<br>⚠️ HTTP Polling（10 秒延遲）',
        version2: '方案 2：預編譯版本',
      ...
      install2Step2: '重啟 OpenClaw',
        ...
        feature1Item4: '⚠️ HTTP Polling（10 秒延遲）',
        feature2: '預編譯版本',
     ...
     testAgentsDesc: '你可以發送測試訊息畀：',
      ...
      en: {
        ...
        version1Desc: '✅ Simplest, highest compatibility<br>⚠️ HTTP Polling (10s delay)',
     ...
     install1Step3: 'Register and use',
        ...
        feature1Item4: '⚠️ HTTP Polling (10s delay)',
